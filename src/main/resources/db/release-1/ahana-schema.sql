...
ALTER TABLE ROOM DROP COLUMN MAINTENANCE_STATUS;

ALTER TABLE ROOM ADD COLUMN maintenance_oid varchar(20);

SET SQL_SAFE_UPDATES = 0;
UPDATE ROOM SET maintenance_oid='a0100000018000000019';
